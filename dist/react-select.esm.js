...
<<<<<<< HEAD
      ...
      value: function getFullOptions(props, newOption) {
        ...
        return (allowCreateWhileLoading || !isLoading) && newOption ? createOptionPosition === 'first' ? [newOption].concat(toConsumableArray(options)) : [].concat(toConsumableArray(options), [newOption]) : options;
      }
    }]);
    return Creatable;
  }(Component), _class.defaultProps = defaultProps$2, _initialiseProps = function _initialiseProps() {
    var _this3 = this;
